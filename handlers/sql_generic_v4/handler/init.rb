...
class SqlGenericV4
  ...
  kapp_form_slug = @info_values["kapp_form_slug"]
  ...
  error_message = nil
    ...
    begin
      kinetic_api_route = "#{@info_values["kinetic_api_location"]}/kapps/#{kapp_slug}/forms/" +
        "#{kapp_form_slug}/submissions?q=values[Template Name]=\"#{template_name}\"&include=values"
